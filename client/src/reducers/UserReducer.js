...
export default (state = initialState, action) => {
  switch (action.type) {
    case USER_ACTION_TYPE.ADMIN_EDIT_REQUEST:
    case USER_ACTION_TYPE.ADMIN_DELETE_REQUEST:
    case USER_ACTION_TYPE.FETCH_REQUEST:
    case USER_ACTION_TYPE.PATIENT_EDIT_REQUEST:
    ...
    case USER_ACTION_TYPE.ADMIN_EDIT_SUCCESS:
    case USER_ACTION_TYPE.ADMIN_EDIT_FAILURE:
    case USER_ACTION_TYPE.FETCH_SUCCESS:
    case USER_ACTION_TYPE.FETCH_FAILURE:
    case USER_ACTION_TYPE.PATIENT_EDIT_SUCCESS:
    case USER_ACTION_TYPE.PATIENT_EDIT_FAILURE:
